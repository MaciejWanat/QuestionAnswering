...
# This file is part of quepyExample and is distributed under the Modified BSD License.
...
"""
Main script for DBpedia quepyExample.
"""
...
# quepyExample.set_loglevel("DEBUG")
...
# main loop
while 1:
        question = raw_input("Whats on your mind? Ask me about people.\n")
        target, query, metadata = dbpedia.get_query(question)
